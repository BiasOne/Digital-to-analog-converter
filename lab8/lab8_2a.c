...
int main(void)
{
	...
	while(1)
	{
		if(randomFlag)
		{
			...
			DACA.CH0DATA = sinewaveVect[iter++];
...
void tcc0_init(void)
{
	TCC0.PER=63; //The original period i calculated gave me a period of 16k = (1/1000)((32x10^6)/2) but resulted in a frequency of over 60k
