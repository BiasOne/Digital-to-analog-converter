...
uint16_t triangleWaveVect[256] = {0x20,0x40,0x60,0x80,0xa0,0xc0,0xe0,0x100,
...
int main(void)
{
	...
	while(1)
	{
		...
		else if(input==0x33) //3
		{		 
			TCC0.PER=56;			
		}
		else if(input==0x65) //e
		{			
			TCC0.PER=55;			
		}
		else if(input==0x34) //4
		{			
			TCC0.PER=54;		
		}
		else if(input==0x72) //r
		{			
			TCC0.PER=47;		
		}
		else if(input==0x74) //t
		{			
			TCC0.PER=46;		
		}
		else if(input==0x54) //6
		{		
			TCC0.PER=42;	
		}
		else if(input==0x79) //y
		{		
			TCC0.PER=40;
		}
		else if(input==0x37) //7
		{	
			TCC0.PER=37;	
		}
		else if(input==0x75) //u
		{	
			TCC0.PER=35;	
		}
		else if(input==0x35) //8
		{	
			TCC0.PER=33;	
		}
		else if(input==0x69) //i
		{	
			TCC0.PER=31;	
		}
		else if(input==0x73) //s
		{	
			DMA.CH0.CTRLA = 0;			
			DMA.CH0.TRFCNT= (uint16_t)(sizeof(sinewaveVect));
			...
			{
				triangle = 1;
				DMA.CH0.SRCADDR0= (uint8_t)((uintptr_t)triangleWaveVect);
				DMA.CH0.SRCADDR1= (uint8_t)((uintptr_t)triangleWaveVect >> 8);
				DMA.CH0.SRCADDR2= (uint8_t)(((uint32_t)((uintptr_t)triangleWaveVect)) >> 16);
